...
function InputArea({title, placeholder, update}) {
  return (
    <div>
        ...
        <textarea 
          rows={3}
          className="z-[100] pointer-events-auto text-xs  bg-black bg-opacity-60 appearance-none block w-full text-white border focus:outline-none rounded shadow-sm focus:border-green-500 py-3 px-4 mb-3 leading-tight " 
