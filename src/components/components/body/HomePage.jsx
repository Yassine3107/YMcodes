  ...
  return (
    <div className="absolute inset-0 flex flex-col justify-between mt-36">
      <div className="flex flex-col items-center">
          ...
          <button className='z-[101] border-2 border-slate-700 hover:border-1 hover:bg-gradient-to-r from-green-500 to-lime-400 text-white py-2 px-3 rounded-full mt-6 pointer-events-auto bring-front'>
            Contact Me
          </button>
        </div>
        <BounceScrollSwipe/>
